...
# Author  : SYSTEM ELECTRIC
# (C) Copyright 2021-2022 By SYSTEM ELECTRIC
# =========================================
...
echo -e "           OWNER : ${GREEN} BTR ${NC}${YELLOW}(${NC} ${GREEN} SC BY SYSTEM ELECTRIC${NC}${YELLOW})${NC}"
echo -e "       © Copyright By system Electric ${YELLOW}(${NC} 2022-2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
